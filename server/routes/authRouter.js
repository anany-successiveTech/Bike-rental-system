...
import { registerSchema, loginSchema, passwordResetSchema } from "../validations/authValidation.js";
...
authrouter.post("/password-reset", validate(passwordResetSchema), authentication, passwordReset);
